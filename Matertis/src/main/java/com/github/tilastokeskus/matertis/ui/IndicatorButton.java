 ...
 */
public class IndicatorButton extends AbstractButton {
    ...
    public IndicatorButton(String label) {
        this(new AbstractAction(label) {
            @Override public void actionPerformed(ActionEvent e) {}
        });
    }
    
    public IndicatorButton(AbstractAction action) {
        super(action);
        ...
        this.add(lab, "center, gapx " + INDICATOR_WIDTH + " 0");
    }
